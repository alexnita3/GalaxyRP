...
void Cmd_ListAccount_f( gentity_t *ent ) {
	if (ent->client->sess.amrpgmode == 2)
	{
		...
		else if (trap->Argc() == 2)
		{
			...
			{
				trap->SendServerCommand( ent-g_entities, "print \"\n^30 - Free Warrior\n^7 Can have all 56 skills. All-round class\n^31 - Force User\n^7 Has saber and force. Force powers use less force. Regens force faster\n^32 - Bounty Hunter\n^7 can have guns, more max ammo, more powerful holdable items and more credits in battles\n^33 - Armored Soldier\n^7 gun class with high resistance to damage, shot deflection and auto-shield-heal\n^34 - Monk\n^7 force class with highest melee damage and faster run speed. Has auto-hp-heal\n^35 - Stealth Attacker\n^7 Highest gun damage. Resistant to electric attacks\n^36 - Duelist\n^7 force class with highest saber damage\n^37 - Force Gunner\n^7 gun/force class. Can do acrobatic moves (like wall run) while holding guns and shooting\n^38 - Magic Master\n^7 Has no saber/force/guns. Shoots magic bolts from melee. Learns all magic powers\n^39 - Force Tank\n^7 saber/force class. High resistance to damage\n\n^3/rpgclass <class number>\n\"" );
			}
