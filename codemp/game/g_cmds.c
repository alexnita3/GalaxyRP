...
void Cmd_Magic_f( gentity_t *ent ) {
	...
	if (trap->Argc() == 1)
	{
		trap->SendServerCommand( ent-g_entities, va("print \"\n 0 - Magic Sense - %s^7\n 1 - ^4Healing Water - %s^7\n 2 - ^4Water Splash - %s^7\n 3 - ^4Water Attack - %s^7\n 4 - ^3Earthquake - %s^7\n 5 - ^3Rockfall - %s^7\n 6 - ^3Shifting Sand - %s^7\n 7 - ^2Sleeping Flowers - %s^7\n 8 - ^2Poison Mushrooms - %s^7\n 9 - ^2Tree of Life - %s^7\n10 - ^5Magic Shield - %s^7\n11 - ^5Dome of Damage - %s^7\n12 - ^5Magic Disable - %s^7\n13 - ^6Ultra Speed - %s^7\n14 - ^6Slow Motion - %s^7\n15 - ^6Fast and Slow - %s^7\n16 - ^1Flame Burst - %s^7\n17 - ^1Ultra Flame - %s^7\n18 - ^1Flaming Area - %s^7\n19 - Blowing Wind - %s^7\n20 - Hurricane - %s^7\n21 - Reverse Wind - %s^7\n22 - ^3Ultra Resistance - %s^7\n23 - ^3Ultra Strength - %s^7\n24 - ^3Enemy Weakening - %s^7\n25 - ^5Ice Stalagmite - %s^7\n26 - ^5Ice Boulder - %s^7\n27 - ^5Ice Block - %s^7\n28 - Healing Area - %s^7\n29 - Magic Explosion - %s^7\n30 - Lightning Dome - %s^7\n\"", 
